...
g4 <- tbl.compareRS %>% 
  ...
  scale_color_manual(values = c(RIG.red, RIG.green, RIG.blue),  name = "",   #"Return \nScenarios",
                     label  = g.label) +
  labs(title = "Median funded ratio \n under different return scenarios and funding policies", x = NULL, y = "Funded ratio (%)") +
  theme(axis.text.x = element_text(size = 7), legend.position="right") +
  guides(color = guide_legend(keywidth = 1.5, keyheight = 3)) +
  RIG.theme
...
g5 <- tbl.compareRS %>% 
  ...
  scale_color_manual(values = c(RIG.red, RIG.green, RIG.blue),  name = "",   #"Return \nScenarios",
                     label  = g.label) +
  labs(title = "Median employer contribution \n under different return scenarios and funding policies", x = NULL, y = "Employer contribution rate (%)") +
  theme(axis.text.x = element_text(size = 7), legend.position="right") +
  guides(color = guide_legend(keywidth = 1.5, keyheight = 3)) + 
  RIG.theme
