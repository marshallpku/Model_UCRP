...
g1 <- lresults_RS1.Cap$g.distReturn  + 
  ylab(label = "Simulation count")
g1 

g.height <- 5.5
g.width <- 9

ggsave(file = paste0(Outputs_folder, "fig1_DistReturn.png"), g1, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "fig1_DistReturn.pdf"), g1, height = g.height, width = g.width)

# load(paste0(folderName, "results_RS1.Cap.RData"))
# g.dist_5year <- penSim_results %>% 
#   filter(sim > 0, year <=2019) %>% 
#   group_by(sim) %>% 
#   summarize(geoReturn = get_geoReturn(i.r)) %>% 
#   summarize(posReturn = 100 * sum(geoReturn <= 0.00)/n()  )
# g.dist_5year
# 
# g.dist_30year <- penSim_results %>% 
#   filter(sim > 0, year <=2044) %>% 
#   group_by(sim) %>% 
#   summarize(geoReturn = get_geoReturn(i.r)) %>% 
#   summarize(posReturn = 100 * sum(geoReturn <=0.0)/n()  )
# g.dist_30year
...
g1$data %>% select(year, i.r, runname, sim, geoReturn) %>% ungroup %>% 
  filter(geoReturn == max(geoReturn), i.r <= 0)

x <- g3$data %>% select(year, i.r, runname, sim, geoReturn, FR.MA) %>% ungroup 
#%>% filter(year == 2044)
...
ggsave(file = paste0(Outputs_folder, "fig13_indivRuns.annualReturn.png"), g1, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "fig14_indivRuns.rollingReturn.png"), g2, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "fig15_indivRuns.FRpath.png"), g3, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "fig16_indivRuns.ERCpath.png"), g4, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "indivRuns.rolling5yReturn.png"), g5, height = g.height, width = g.width)


ggsave(file = paste0(Outputs_folder, "fig13_indivRuns.annualReturn.pdf"), g1, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "fig14_indivRuns.rollingReturn.pdf"), g2, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "fig15_indivRuns.FRpath.pdf"), g3, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "fig16_indivRuns.ERCpath.pdf"), g4, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "indivRuns.rolling5yReturn.pdf"), g5, height = g.height, width = g.width)
...
ggsave(file = paste0(Outputs_folder, "fig2_sumStchResults.FR40.rolling.png"), g1.1, height = g.height, width = g.width)
...
ggsave(file = paste0(Outputs_folder, "sumStchResults.FR40.pdf"), g1, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "fig2_sumStchResults.FR40.rolling.pdf"), g1.1, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "sumStchResults.ERCIncrease.pdf"), g2, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "sumStchResults.ERCIncrease6pts.pdf"), g3, height = g.height, width = g.width)
...
grid.newpage()
note <- 'Note: The lines for "w/o Cap" (green line) and "ADC" (blue line) are almost overlapped.'
g1.1 <- arrangeGrob(g1.1, bottom = textGrob(note, x = 0, hjust = -0.1, vjust=0.1, 
...
grid.newpage()
note <- 'Note: In the leftmost panel (funding approach "with Cap"), the 75th percentile line (blue) and the median line (green) are overlapped.'
g5 <- arrangeGrob(g5, bottom = textGrob(note, x = 0, hjust = -0.08, vjust=0.1, 
                                      gp = gpar(fontface = "plain", fontsize = 9)))
grid.draw(g5)
...
ggsave(file = paste0(Outputs_folder, "fig3_ComparePolicies.FR40.rolling.png"), g1.1, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "fig4_ComparePolicies.FR_dist.png"), g2, height = 4, width = 12)

ggsave(file = paste0(Outputs_folder, "fig18_ComparePolicies.highERC.png"), g3, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "fig5_ComparePolicies.ERCIncrease.png"), g4, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "fig6_ComparePolicies.ERC_dist.png"), g5, height = 4, width = 12)


ggsave(file = paste0(Outputs_folder, "ComparePolicies.FR40.pdf"), g1, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "fig3_ComparePolicies.FR40.rolling.pdf"), g1.1, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "fig4_ComparePolicies.FR_dist.pdf"), g2, height = 4, width = 12)

ggsave(file = paste0(Outputs_folder, "fig18_ComparePolicies.highERC.pdf"), g3, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "fig5_ComparePolicies.ERCIncrease.pdf"), g4, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "fig6_ComparePolicies.ERC_dist.pdf"), g5, height = 4, width = 12)
...
# Comparison of return scenarios: low return periods
...
fig.labels <- c("Scenario 2: \nAssumption achieved \nstochastic", "Scenario 3: \n6 years of low returns", "Scenario 4: \n15 years of low returns")

note0 <- 'Notes:'
note1 <- '  Scenario 2: Expected compound return is 7.25%, standard deviation is 12%.'
note2 <- '  Scenario 3: Expected compound return is 6.9%, standard deviation is 12%.'
note3 <- '  Scenario 4: Expected compound return is 6.4%, standard deviation is 12%.'
note <- paste0("\n\n", note0, "\n", note1, "\n", note2, "\n", note3)
...
g1 <- tbl.compareRS %>% 
  ...
  scale_color_manual(values = c(RIG.red, RIG.green, RIG.blue),  name = "",   #"Return \nScenarios",
                     label  = fig.labels) +
  labs(title = "Probability of funded ratio below 40% \nat any time prior to and including the given year \n under different return scenarios and funding approaches", x = NULL, y = "Probability (%)") +
  theme(axis.text.x = element_text(size = 7), legend.position="right") +
  guides(color = guide_legend(keywidth = 1.5, keyheight = 3)) + 
  RIG.theme

grid.newpage()
g1 <- arrangeGrob(g1, bottom = textGrob(note, x = 0.04, hjust = -0, vjust=0.1, 
                                      gp = gpar(fontface = "plain", fontsize = 9)))
grid.draw(g1)
...
grid.newpage()
g1.1 <- arrangeGrob(g1.1, bottom = textGrob(note, x = 0.04, hjust = -0, vjust=0.1, 
                                      gp = gpar(fontface = "plain", fontsize = 9)))
grid.draw(g1.1)

# grid.newpage()
# note0 <- 'Note: The lines for "w/o Cap" (green line) and "ADC" (blue line) are almost overlapped.'
# g1.1 <- arrangeGrob(g1.1, bottom = textGrob(note, x = 0, hjust = -0.1, vjust=0.1, 
#                                       gp = gpar(fontface = "plain", fontsize = 9)))
# grid.draw(g1.1)
...
grid.newpage()
g2 <- arrangeGrob(g2, bottom = textGrob(note, x = 0.04, hjust = -0, vjust=0.1, 
                                      gp = gpar(fontface = "plain", fontsize = 9)))
grid.draw(g2)
...
grid.newpage()
g3 <- arrangeGrob(g3, bottom = textGrob(note, x = 0.04, hjust = -0, vjust=0.1, 
                                      gp = gpar(fontface = "plain", fontsize = 9)))
grid.draw(g3)
...
ggsave(file = paste0(Outputs_folder, "fig7_CompareRS.FR40.rolling.png"), g1.1, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "fig19_CompareRS.highERC.png"), g2, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "fig8_CompareRS.ERCIncrease.png"), g3, height = g.height, width = g.width)

ggsave(file = paste0(Outputs_folder, "CompareRS.FR40.pdf"), g1, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "fig7_CompareRS.FR40.rolling.pdf"), g1.1, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "fig19_CompareRS.highERC.pdf"), g2, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "fig8_CompareRS.ERCIncrease.pdf"), g3, height = g.height, width = g.width)
...
# Comparison of return scenarios: low return periods, summary table
...
# Comparison of return scenarios, more scenarios from UCRP
...
g1 <- tbl.comparePolicies %>% 
  ggplot(aes(x = year, y = FR95more, color = factor(runname, levels = c("RS1.Cap", "RS1.noCap", "RS1.ADC")))) + theme_bw() + 
  geom_line() + geom_point() +
  ...
  scale_color_manual(values = c(RIG.red, RIG.green, RIG.blue),  name = "Contribution \napproaches", 
                     label  = c("w/ Cap", "w/o Cap", "ADC")) + 
  labs(title = "Probability of funded ratio above 95% in a given year \n under different funding approaches",
       x = NULL, y = "Probability (%)") + 
  RIG.theme

g1$data %>% select(runname, FR95more, year)
...
ggsave(file = paste0(Outputs_folder, "fig17_FR95more.png"), g1, height = 7, width = 9)
ggsave(file = paste0(Outputs_folder, "FR95more.rolling.png"), g2, height = 7, width = 9)

ggsave(file = paste0(Outputs_folder, "fig17_FR95more.pdf"), g1, height = 7, width = 9)
ggsave(file = paste0(Outputs_folder, "FR95more.rolling.pdf"), g2, height = 7, width = 9)
...
# Comparison of return scenarios: 2 alternative scenarios
...
note0 <- 'Notes:'
note1 <- '  Scenario 2: Expected compound return is 7.25%, standard deviation is 12%.'
note2 <- '  Scenario 5: Expected compound return is 7.25%, standard deviation is 16%.'
note3 <- '  Scenario 6: Expected compound return is 6%, standard deviation is 11%.'
note <- paste0("\n\n", note0, "\n", note1, "\n", note2, "\n", note3)
...
g1 <- tbl.compareRS %>% 
  ...
  scale_color_manual(values = c(RIG.red, RIG.green, RIG.blue),  name = "",   #"Return \nScenarios",
                     label  = g.label) +
  labs(title = "Probability of funded ratios below 40% \nat any time prior to and including the given year \n under different return scenarios and funding approaches", x = NULL, y = "Probability (%)") +
  theme(axis.text.x = element_text(size = 7), legend.position="right") +
  guides(color = guide_legend(keywidth = 1.5, keyheight = 3)) + 
  RIG.theme
...
g4 <- tbl.compareRS %>% 
  ...
  scale_color_manual(values = c(RIG.red, RIG.green, RIG.blue),  name = "",   #"Return \nScenarios",
                     label  = g.label) +
  labs(title = "Median funded ratios \n under different return scenarios and funding approaches", x = NULL, y = "Funded ratio (%)") +
  theme(axis.text.x = element_text(size = 7), legend.position="right") +
  guides(color = guide_legend(keywidth = 1.5, keyheight = 3)) +
  RIG.theme

grid.newpage()
g4 <- arrangeGrob(g4, bottom = textGrob(note, x = 0.04, hjust = -0, vjust=0.1, 
                                      gp = gpar(fontface = "plain", fontsize = 9)))
grid.draw(g4)
...
g5 <- tbl.compareRS %>% 
  ...
  scale_color_manual(values = c(RIG.red, RIG.green, RIG.blue),  name = "",   #"Return \nScenarios",
                     label  = g.label) +
  labs(title = "Median employer contribution rates \n under different return scenarios and funding approaches", x = NULL, y = "Employer contribution rate (%)") +
  theme(axis.text.x = element_text(size = 7), legend.position="right") +
  guides(color = guide_legend(keywidth = 1.5, keyheight = 3)) + 
  RIG.theme

grid.newpage()
g5 <- arrangeGrob(g5, bottom = textGrob(note, x = 0.04, hjust = -0, vjust=0.1, 
                                      gp = gpar(fontface = "plain", fontsize = 9)))
grid.draw(g5)
...
ggsave(file = paste0(Outputs_folder, "fig10_CompareRS2.FR40.rolling.png"), g1.1, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "fig20_CompareRS2.highERC.png"), g2, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "fig12_CompareRS2.ERCIncrease.png"), g3, height = g.height, width = g.width)

ggsave(file = paste0(Outputs_folder, "fig9_CompareRS2.FR.Med.png"), g4, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "fig11_CompareRS2.ERC.Med.png"), g5, height = g.height, width = g.width)


ggsave(file = paste0(Outputs_folder, "CompareRS2.FR40.pdf"), g1, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "fig10_CompareRS2.FR40.rolling.pdf"), g1.1, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "fig20_CompareRS2.highERC.pdf"), g2, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "fig12_CompareRS2.ERCIncrease.pdf"), g3, height = g.height, width = g.width)

ggsave(file = paste0(Outputs_folder, "fig9_CompareRS2.FR.Med.pdf"), g4, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "fig11_CompareRS2.ERC.Med.pdf"), g5, height = g.height, width = g.width)
