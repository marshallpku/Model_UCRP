...
ggsave(file = paste0(Outputs_folder, "DistReturn.pdf"), g1, height = g.height, width = g.width)


# 
# load(paste0(folderName, "results_RS1.Cap.RData"))
# 
# g.dist_30year <- results.stch %>% group_by(sim) %>% 
#    summarize(geoReturn = get_geoReturn(i.r)) %>% 
#    ggplot(aes(100 * geoReturn)) + theme_bw() + 
#    geom_histogram(aes(y = ..count.. / sum(..count..)), color = "black", fill = RIG.blue, binwidth = 1, boundary  = 0) + 
#   geom_vline(xintercept = 7.25, color = RIG.red) + 
#    scale_y_continuous(labels = percent) + 
#    scale_x_continuous(breaks = seq(-50, 50, 5)) + 
#    coord_cartesian(xlim = c(-30, 50)) + 
#    labs(x = "Rate of return (%)",
#         y = "Pencentage in 2000 simulations",
#         title = "Distribution of 30-year compound annual return over 2,000 simulations") + 
#    RIG.theme
# g.dist_30year
# 
# 
# set.seed(1234)
# g.dist_1year <-  
#   data.frame(i.r = rnorm(2000, mean = 0.0725, sd = 0.12)) %>% 
#   ggplot(aes(100 * i.r )) + theme_bw() + 
#   geom_histogram(aes(y = (..count..) / sum(..count..)), color = "black", fill = RIG.blue, binwidth = 1, boundary  = 0) + 
#   geom_vline(xintercept = 7.25, color = RIG.red) + 
#   scale_y_continuous(labels = percent) + 
#   scale_x_continuous(breaks = seq(-50, 50, 5)) + 
...
#   labs(x = "Rate of return (%)",
#        y = "Pencentage in 2000 simulations",
#        title = "Distribution of 1-year annual return over 2,000 simulations") + 
#   RIG.theme
# 
# 
# g.dist_totReturn <- results.stch %>% group_by(sim) %>% 
#    summarize(totReturn = prod(i.r + 1) ) %>% 
#    ggplot(aes(100 * (totReturn - 1)  )) + theme_bw() + 
#    geom_histogram(aes(y = ..count.. / sum(..count..)), color = "black", fill = RIG.blue, binwidth = 10, boundary  = 0) + 
#    #scale_y_continuous(labels = percent) + 
#    scale_x_continuous(breaks = seq(-50, 50, 5)) + 
#    #coord_cartesian(xlim = c(-30, 50)) + 
#    labs(x = "Rate of return (%)",
...
# 
# 
# g.distReturn <- arrangeGrob(g.dist_1year, g.dist_30year, nrow = 2, ncol = 1)
# grid.draw(g.distReturn)
...
ggsave(file = paste0(Outputs_folder, "indivRuns.annualReturn.pdf"), g1, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "indivRuns.rollingReturn.pdf"), g2, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "indivRuns.FRpath.pdf"), g3, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "indivRuns.ERCpath.pdf"), g4, height = g.height, width = g.width)
...
ggsave(file = paste0(Outputs_folder, "sumStchResults.FR40.rolling.pdf"), g1.1, height = g.height, width = g.width)
...
ggsave(file = paste0(Outputs_folder, "ComparePolicies.FR40.rolling.pdf"), g1.1, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "ComparePolicies.FR_dist.pdf"), g2, height = 4, width = 12)

ggsave(file = paste0(Outputs_folder, "ComparePolicies.highERC.pdf"), g3, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "ComparePolicies.ERCIncrease.pdf"), g4, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "ComparePolicies.ERC_dist.pdf"), g5, height = 4, width = 12)
...
ggsave(file = paste0(Outputs_folder, "CompareRS.FR40.rolling.pdf"), g1.1, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "CompareRS.highERC.pdf"), g2, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "CompareRS.ERCIncrease.pdf"), g3, height = g.height, width = g.width)
...
ggsave(file = paste0(Outputs_folder, "FR95more.pdf"), g1, height = 7, width = 9)
...
ggsave(file = paste0(Outputs_folder, "CompareRS2.FR40.rolling.pdf"), g1.1, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "CompareRS2.highERC.pdf"), g2, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "CompareRS2.ERCIncrease.pdf"), g3, height = g.height, width = g.width)

ggsave(file = paste0(Outputs_folder, "CompareRS2.FR.Med.pdf"), g4, height = g.height, width = g.width)
ggsave(file = paste0(Outputs_folder, "CompareRS2.ERC.Med.pdf"), g5, height = g.height, width = g.width)
