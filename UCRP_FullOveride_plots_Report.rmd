...
g2 <- tbl.comparePolicies %>%
  ...
  labs(title = "Distribution of funded ratio across simulations under different funding approaches",
       x = NULL, y = "Percent") + 
...
g5 <- tbl.comparePolicies %>%
  ...
  scale_color_manual(values = c(RIG.red, RIG.green, RIG.blue),  name = "Contribution \napproaches", 
                     label  = c("25th percentile", "median", "75th percentile")) + 
  labs(title = "Distribution of employer contribution across simulations under different funding approaches",
       x = NULL, y = "Percent") +
  theme(axis.text.x = element_text(size = 8)) + 
  RIG.theme
