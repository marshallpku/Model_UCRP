...
* In each simulation, returns are drawn from a normal distribution with mean 7.97% and standard deviation 12%, which implies an average long-term compound (geometric) return of 7.25%. The 25th and 75th percentiles of this return distributin are -0.12% and 16.1% respectively.
